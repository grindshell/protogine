...
is drafted as of 2026-09-08 in the
[M2 contract](docs/implementation/TILEMAP_COLLISION_M2.md) and is **proposed
rather than frozen, with no implementation behind it**; M3 and M4 remain
undesigned. All three are required core scope, so the overall feature and this
